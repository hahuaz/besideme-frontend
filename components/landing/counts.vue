<template>
  <div class="py-32">
    <div class="text-center mb-16">
      <p class="text-sm text-c-blue font-semibold">On 2021</p>
      <p class="text-4xl text-blue-dark font-bold">See Our Success</p>
    </div>
    <div
      ref="counts"
      class="counts__container grid grid-cols-4 justify-around items-center"
    >
      <div class="count">
